...
function createDefaultSeed(): DatabaseSchema {
  ...
  const stationsList: Station[] = [
    {
      ...
      name: 'North Gate Fuel Station',
      code: 'ST-01',
      address: 'North Industrial Area, Forecourt 1, Ring Road West',
    ...
    },
    {
      ...
      organizationId: INITIAL_ORG_ID,
      name: 'East Legon Fuel Station',
      code: 'ST-02',
      address: 'East Legon Bypass, Fuel Bay B',
    ...
    },
    {
      ...
      organizationId: INITIAL_ORG_ID,
      name: 'West Point Fuel Station',
      code: 'ST-03',
      address: 'West Point Highway, Commercial Pump 4',
    ...
    },
    {
      ...
      organizationId: INITIAL_ORG_ID,
      name: 'Airport City Fuel Station',
      code: 'ST-04',
      address: 'Airport Bypass, Commercial Forecourt Complex',
    ...
    },
    {
      ...
      organizationId: INITIAL_ORG_ID,
      name: 'Tema Port Fuel Depot Station',
      code: 'ST-05',
      address: 'Tema Port Bulk Distribution Bay 3',
  ...
  const usersList: (User & { passwordHash: string })[] = [
    ...
    },
    {
      ...
      stationName: 'North Gate Fuel Station',
